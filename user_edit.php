...
if (empty($id) || empty($login) || empty($senha_atual) || empty($senha_nova) || empty($confirma_senha_nova)) { header('Location: user.php?erro=campos_vazios'); exit; }
...
$senha_trocada = password_hash($senha_nova, PASSWORD_DEFAULT);
$query->bindValue(':senha', $senha_trocada);
$query->execute();

$_SESSION['user']['login'] = $login;
$_SESSION['user']['senha'] = $senha_trocada;
